        ...
        <section class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">
                How to read a GPC Program Advisement Form - <a href="">Video</a>
              </li>
              <li class="list-group-item">
...
">http://depts.gpc.edu/tag/</a>
      	...
      	<section class="panel panel-default">
              ...
              <li class="list-group-item">
                Career Opportunities for various programs of study - <a href="">PDF</a>
              </li>
						</ul>
					</div>
				</section>
        ...
        <section class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">
                GPC Tuition Classification Policy - <a href="">PDF</a>
              </li>
            </ul>
          </div>
        </section>
